package me.jwhz.customenchant.itemnbtapi;

import me.jwhz.customenchant.itemnbtapi.utils.GsonWrapper;
import me.jwhz.customenchant.itemnbtapi.utils.MethodNames;
...
public class NBTReflectionUtil {
    ...
    public static byte getType(NBTCompound comp, String key) {
        ...
        try {
            ...
            return Byte.valueOf(String.valueOf(method.invoke(workingtag, key)));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return 0;
